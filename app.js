...
const termsRoutes = require('./routes/terms'); // Include terms routes
const privacyRoutes = require('./routes/privacy'); // Include privacy routes
...
app.use('/terms', termsRoutes); // Use terms route
app.use('/privacy', privacyRoutes); // Use privacy route
